...
const SidePanel = ({ children, closePanel, width = 'medium', position = 'right', title = '' }:SidePanelProps) => {
   ...
   return (
       <div className="SidePanel fixed w-full h-screen top-0 left-0 z-50" onClick={closeOnBGClick}>
         ...
         ${position === 'left' ? 'left-0' : 'right-0'} h-screen flex flex-col`}>
            <div className='SidePanel__header px-5 py-4 text-slate-500 border-b border-b-gray-100 shrink-0'>
