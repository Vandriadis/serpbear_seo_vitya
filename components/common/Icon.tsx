...
const Icon = ({ type, color = 'currentColor', size = 16, title = '', classes = '' }: IconProps) => {
   ...
   return (
       <span className={`icon inline-block relative top-[2px] ${classes}`} title={title}>
         ...
         {type === 'sun'
            && <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
               <path fill={color} d="M12 18a6 6 0 1 1 0-12a6 6 0 0 1 0 12zm0-16a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1zm0 18a1 1 0 0 1 1 1v1a1 1 0 1 1-2 0v-1a1 1 0 0 1 1-1zM3 11a1 1 0 1 0 0 2h1a1 1 0 1 0 0-2H3zm17 0a1 1 0 1 0 0 2h1a1 1 0 1 0 0-2h-1zM5.636 5.636a1 1 0 0 1 1.414 0l.707.707a1 1 0 1 1-1.414 1.414l-.707-.707a1 1 0 0 1 0-1.414zm12.728 12.728a1 1 0 0 1 1.414 0l.707.707a1 1 0 0 1-1.414 1.414l-.707-.707a1 1 0 0 1 0-1.414zM18.364 5.636a1 1 0 0 1 0 1.414l-.707.707a1 1 0 1 1-1.414-1.414l.707-.707a1 1 0 0 1 1.414 0zM6.343 17.657a1 1 0 0 1 0 1.414l-.707.707a1 1 0 0 1-1.414-1.414l.707-.707a1 1 0 0 1 1.414 0z" />
            </svg>
         }
         {type === 'moon'
            && <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
               <path fill={color} d="M12.1 22c-5.523 0-10-4.477-10-10c0-4.163 2.543-7.722 6.142-9.237a.75.75 0 0 1 .963.963A8.25 8.25 0 0 0 19.274 15a.75.75 0 0 1 .963.963C18.722 19.457 15.163 22 12.1 22z" />
            </svg>
         }
         {type === 'star'
            && <svg width={size} viewBox="0 0 24 24" {...xmlnsProps}>
